...
<form method="post" action="search.php" autocomplete="off">
	...
	<div class = "contentLabel">
		<h1><?php echo $findme; ?></h1>
		<div class = "insideContentLabel">
			<a href="all.php" class = "selected">All</a>
 ...
 <div class = "content">
		...
		<?php 
			...
			$sql_query = "select * from tbl_products where status = 1 order by id desc";
			}else{
		...
		<div class = "notFound"><p><?php echo $errMess; ?></p></div>
