...
<form method="post" action="search.php" autocomplete="off">
 ...
 <div class = "content">
		...
		<?php 
			...
			$sql_query = "select * from tbl_products where status = 1 and category = 'Vegetables' order by id desc limit 4";
			$sql_query1 = "select * from tbl_products where status = 1 and category = 'Fruits' order by id desc limit 4";
			$sql_query2 = "select * from tbl_products where status = 1 and category = 'Root Crops' order by id desc limit 4";
			$sql_query3 = "select * from tbl_products where status = 1 and category = 'Others' order by id desc limit 4";
		 ...
		 ?>
			<div class = "card">
				<a href = "viewProduct.php?viewProduct=<?php echo $row['id']; ?>"><img class = "myimg" src="<?php	echo 'images/'. $row['image'] . ' '; ?>" /></a>
	 				...
	 				<p class="price"> <?php echo "₱ ". $row['price'] . ".00 / kls"; ?></p>
...
<div class = "seeALL"><a href="all.php">See all products</a></div>
